...
2. **Installs the Saxess Pro iOS application** on a trusted mobile device.
...
1. Invite employees/users via email.
2. Assign **roles and access policies**.
3. Each employee completes:
